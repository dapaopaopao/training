					...
					<view class="page-view">
						<view class="class-item">
							...
							<view class="item-container">
								<view :class="['item-container-2',chooseList.find((action)=>{return action.name===item1.name})?'isActive':'']" @click="chooseFood(item1)" v-for="(item1, index1) in item.foods" :key="index1">
...
<script>
	...
	import classifyData from "@/pages/food/foodData.js";
	...
	export default {
		...
		methods: {
			...
			...mapMutations(['addAction','deleteAction','resetfoodList']),
			...
			setChoose(){
				this.foodList.push(...this.chooseList)
